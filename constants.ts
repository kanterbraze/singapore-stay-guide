...
export const SINGAPORE_LOCATIONS: LocationData[] = [
  ...
  },
  {
    ...
    rating: 4.8,
    imageUrl: getUnsplashUrl('1525625244964-3e863e67f5cd'),
    priceRange: '$$$$',
  ...
  },
  {
    ...
    rating: 4.9,
    imageUrl: getUnsplashUrl('1565967511849-76a60a516170'),
    priceRange: 'Free',
  ...
  },
  {
    ...
    rating: 4.7,
    imageUrl: getUnsplashUrl('1569929824647-7e6df696b797'),
    priceRange: '$$$',
  ...
  },
  {
    ...
    rating: 4.8,
    imageUrl: getUnsplashUrl('1534954471550-934c562e6e58'),
    priceRange: '$$$',
  ...
  },
  {
    ...
    rating: 4.5,
    imageUrl: getUnsplashUrl('1506353986638-8e3d6fbf238f'),
    priceRange: 'Free',
  ...
  },
  {
    ...
    rating: 4.6,
    imageUrl: getUnsplashUrl('1567355042657-6570c9c22881'),
    priceRange: 'Free',
  ...
  // --- Events & Activities (New Category) ---
  {
    ...
    rating: 4.7,
    imageUrl: getUnsplashUrl('1534062828608-89f532a264a2'),
    priceRange: '$$$$',
  ...
  },
  {
    ...
    rating: 4.5,
    imageUrl: getUnsplashUrl('1466023308892-d9616e3c0133'),
    priceRange: '$$$',
  ...
  },
  {
    ...
    rating: 4.6,
    imageUrl: getUnsplashUrl('1526487820421-88e6a17b8f9e'),
    priceRange: '$$$',
  ...
  },
  {
    ...
    rating: 4.7,
    imageUrl: getUnsplashUrl('1544415842-88746c825a1e'),
    priceRange: '$$$',
  ...
  },
  {
    ...
    rating: 4.5,
    imageUrl: getUnsplashUrl('1582650085810-7299a9116c4f'),
    priceRange: '$$$',
  ...
  // --- Food (Local Hawker) ---
  {
    ...
    rating: 4.6,
    imageUrl: getUnsplashUrl('1605367657920-561b3658518e'),
    priceRange: '$',
  ...
  },
  {
    ...
    rating: 4.4,
    imageUrl: getUnsplashUrl('1581423405781-a9c1f6087d3a'),
    priceRange: '$$',
  ...
  },
  {
    ...
    rating: 4.7,
    imageUrl: 'https://images.unsplash.com/photo-1549488497-60601d3680e6?auto=format&fit=crop&w=800&q=80',
    priceRange: '$',
  ...
  },
  {
    ...
    rating: 4.3,
    imageUrl: getUnsplashUrl('1603243169213-393223004838'),
    priceRange: '$$',
  ...
  },
  {
    ...
    rating: 4.6,
    imageUrl: getUnsplashUrl('1512418573215-62d08a5cb367'),
    priceRange: '$',
  ...
  },
  {
    ...
    rating: 4.5,
    imageUrl: getUnsplashUrl('1606735584785-1848fdcaea57'),
    priceRange: '$',
  ...
  // --- History ---
  {
    ...
    rating: 4.7,
    imageUrl: getUnsplashUrl('1558253109-1736b47c0780'),
    priceRange: '$$',
  ...
  },
  {
    ...
    rating: 4.6,
    imageUrl: getUnsplashUrl('1630325159048-262102142278'),
    priceRange: '$$',
  ...
  },
  {
    ...
    rating: 4.5,
    imageUrl: getUnsplashUrl('1558269781-6cb93c403328'),
    priceRange: '$$',
  ...
  },
  {
    ...
    rating: 4.6,
    imageUrl: getUnsplashUrl('1505963384242-7db2d32616f7'),
    priceRange: '$$',
  ...
  },
  {
    ...
    rating: 4.6,
    imageUrl: getUnsplashUrl('1561725593-3d0d367c3b28'),
    priceRange: 'Free',
  ...
  // --- Hiking, Nature ---
  {
    ...
    rating: 4.8,
    imageUrl: getUnsplashUrl('1597305917454-9463945c7193'),
    priceRange: 'Free',
  ...
  },
  {
    ...
    rating: 4.7,
    imageUrl: getUnsplashUrl('1625902377755-22d765793049'),
    priceRange: 'Free',
  ...
  // --- Food (Restaurants) ---
  {
    ...
    rating: 4.5,
    imageUrl: getUnsplashUrl('1595865463773-40a23330612c'),
    priceRange: '$$$$',
  ...
  },
  {
    ...
    rating: 4.9,
    imageUrl: getUnsplashUrl('1514362545857-3bc16c4c7d1b'), // Generic fine dining
    priceRange: '$$$$',
  ...
  },
  {
    ...
    rating: 4.8,
    imageUrl: getUnsplashUrl('1514362545857-3bc16c4c7d1b'), // Bar vibe
    priceRange: '$$$$',
  ...
  },
  {
    ...
    rating: 4.6,
    imageUrl: getUnsplashUrl('1598514986236-02a813898083'), // Asian food
    priceRange: '$$',
  ...
  },
  {
    ...
    coordinates: [1.2834, 103.8607],
    rating: 4.3,
    imageUrl: getUnsplashUrl('1570530755850-252f82167d4f'), // Rooftop
    priceRange: '$$$$',

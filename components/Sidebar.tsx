            ...
            <div className="flex flex-col h-full bg-white shadow-xl z-20 w-full md:w-96 overflow-y-auto border-r border-gray-200">
                <div className="relative h-48 sm:h-56 shrink-0">
                    ...
                    <button
                        ...
                        className="absolute top-4 left-4 bg-black/50 hover:bg-black/70 text-white p-2 rounded-full transition-colors backdrop-blur-sm flex items-center gap-1 pr-3"
                    >
                        <ArrowLeft size={20} />
            ...
            <div className="bg-white sticky top-0 z-10 shadow-sm">
                <div className="p-4 md:p-6 pb-2">
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            <h1 className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight">Singapore Guide</h1>
                            <p className="text-gray-500 text-xs md:text-sm mt-1">
                                Explore the Lion City
                            </p>
                        </div>
                    </div>
                    {/* My Stay Section - Compact on Mobile */}
                    <div className="mb-3 bg-slate-50 p-2 md:p-3 rounded-lg border border-slate-100">
                        <div className="flex items-center gap-2 text-[10px] md:text-xs font-semibold text-slate-500 mb-1.5 uppercase tracking-wide">
                    ...
                    <div className="flex border-b border-gray-200 mb-4">
                        <button
                            ...
                            className={`flex-1 pb-2 text-sm font-medium transition-colors border-b-2 ${activeMainTab === 'explore'
                        ...
                        <button
                            ...
                            className={`flex-1 pb-2 text-sm font-medium transition-colors border-b-2 ${activeMainTab === 'trails'
                        ...
                        <>
                            <div className="flex p-1 bg-gray-100 rounded-lg mb-4">
                                <button
                                    ...
                                    className={`flex-1 py-1.5 text-xs font-semibold rounded-md transition-all shadow-sm ${activeListTab === 'curated'
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-1.5 text-xs font-semibold rounded-md transition-all flex items-center justify-center gap-1 shadow-sm ${activeListTab === 'generated'
                        ...
                        {allTrails.map((trail) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`p-4 rounded-xl border cursor-pointer transition-all hover:shadow-md ${activeTrailId === trail.id
                                ...
                                >
                                    <div className="flex justify-between items-start mb-2">
                                        ...
                                        <span className={`text-[10px] uppercase font-bold tracking-wide px-2 py-0.5 rounded-full ${isAiTrail ? 'text-purple-600 bg-purple-100' : 'text-orange-600 bg-orange-100'
                                            }`}>
                                            {trail.category}
                                        </span>
                                    </div>
